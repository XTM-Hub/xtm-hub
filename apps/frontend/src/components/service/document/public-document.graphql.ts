...
// Note: publicDocumentsByServiceSlug (used for the service catalog page and
// sitemap generation) is fetched server-side via graphql-codegen + `serverGraphqlFetch`
// instead of Relay, since those call sites run outside the React/Relay tree.
// See `graphql/document/public-document.query.graphql` and
// `shareable-resources.server.utils.ts`.
