...
export const FilterSidebar = ({ filters }: FilterSidebarProps) => (
  <div className="w-1/6 min-w-[250px] self-start sticky top-[var(--list-header-height,64px)] max-h-[calc(var(--list-scroll-height,100dvh)-var(--list-header-height,64px))] overflow-y-auto p-m bg-elevation-background-layer-1">
