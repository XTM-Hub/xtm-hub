...
// Re-orders a selection back to the canonical column order, regardless of the
// order the columns were (de)selected in, so the exported CSV header is stable.
...
// Renders a single filter field the same way for all 6 filters: a secondary label above a
// MultiSelectFormField bound to react-hook-form's field.value/field.onChange.
