...
export const Autocomplete = ({
  ...
  const handleInputFocus = (
    ...
    const userOnFocus = (children as AutocompleteInputElement).props.onFocus;
  ...
  const handleInputBlur = (
    ...
    const userOnBlur = (children as AutocompleteInputElement).props.onBlur;
  ...
  const childrenWithProps = React.cloneElement(
    children as AutocompleteInputElement,
    {
